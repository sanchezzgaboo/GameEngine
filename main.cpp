    ...
    while (window.isOpen())
    {
        ...
        for(auto tri: meshCube.tris){
            ...
            { 
                ...
                triProjected.p[0]=Matrix_MultiplyVector(matProj, triTranslated.p[0], true);
                triProjected.p[1]=Matrix_MultiplyVector(matProj,triTranslated.p[1], true);
                triProjected.p[2]=Matrix_MultiplyVector(matProj, triTranslated.p[2], true);
